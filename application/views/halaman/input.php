...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container">
                                ...
                                <div class="col-lg">
                                    <div class="p-5">
                                        <div class="text-center">
                                            <h1 class="h4 text-gray-900 mb-4">Input Proyek</h1>
                                        </div>
                                        <form class="user" action="javascript:void(0);">
                                            ...
                                            <button type="submit" class="btn btn-primary btn-user btn-block" onclick="InputProyek()">
                                                Submit
                                            </button>
                                        </form>
                                    </div>
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="row">
                                <div class="col-lg">
                                    <div class="p-5">
                                        <div class="text-center">
                                            <h1 class="h4 text-gray-900 mb-4">Input Lokasi</h1>
                                        </div>
                                        <form class="user" action="javascript:void(0);">
                                            <div class="form-group">
                                                <input type="text" class="form-control form-control-user"
                                            ...
                                            <button type="submit" class="btn btn-primary btn-user btn-block" onclick="InputLokasi()">
                                                Submit
                                            </button>
                                        </form>
                                    </div>
            ...
            <div id="formproyeklokasi" class="row justify-content-center">
                <div class="col-xl-10 col-lg-12 col-md-9">
                    <div class="card o-hidden border-0 shadow-lg my-5 col-lg-9 mx-auto">
                        <div class="card-body p-0">
                            <!-- Nested Row within Card Body -->
                            <div class="row">
                                <div class="col-lg">
                                    <div class="p-5">
                                        <div class="text-center">
                                            <h1 class="h4 text-gray-900 mb-4">Assign Lokasi Proyek</h1>
                                        </div>
                                        <form class="user" action="javascript:void(0);">
                                            <div class="form-group">
                                            ...
                                            <button type="submit" class="btn btn-primary btn-user btn-block"  onclick="InputProyekLokasi()">
                                                Submit
                                            </button>
                                        </form>
                                    </div>
